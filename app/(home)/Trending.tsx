    ...
    return (
        ...
        >
            ...
            <div className="absolute z-2 bottom-0 left-0 p-3">
                <h4 className="inline-block px-5 pt-1 font-semibold bg-accent-orange text-wh-900">
                    {post?.category}
                </h4>
    ...
    return (
        <section className="pt-3 pb-10">
            <div className="flex items-center gap-3">
                ...
                <p className="text-sm">
                    Nunc enim lobortis quam risus et feugiat nibh eu ornare.
            ...
            <p className="text-sm">
                Id cursus purus adipiscing ipsum pretium. Scelerisque
                suspendisse pharetra ultrices mauris ut lacus sagittis pharetra
                dictum. Congue viverra in aliquam feugiat pellentesque.
            </p>
        </section>
    );
};
